...
class Draw extends Base
{
    ...
    {
        $drawSetting = getSystemSetting(self::$site_id, 'draw_setting');
    ...
    public function splitMjImage($imageUrl)
    {
        ...
        $images[] = $this->saveToOss($filepath1);
        // 第2张图片
        ...
        $images[] = $this->saveToOss($filepath2);
        // 第3张图片
        ...
        $images[] = $this->saveToOss($filepath3);
        // 第4张图片
        ...
        $images[] = $this->saveToOss($filepath4);
     ...
     * 将图片保存到云存储
     */
    public function saveToOss($filepath)
    {
        // 上传到oss
        $url = '';
